/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: eff05306e71fafe710def474aa9f9df4)
// Runtime types generated with workerd@1.20260714.1 2026-07-21 nodejs_compat
interface __BaseEnv_Env {
	JOB_ARTIFACTS: KVNamespace;
	ASSETS: Fetcher;
	ENVIRONMENT: "production" | "development";
	FEATURE_PUBLIC_JOBS: "true";
	FEATURE_PUBLIC_SWARM: "true";
	MAX_ACTIVE_JOBS: "100";
	MAX_JOB_CONNECTIONS: "32";
	MAX_DIRECTORY_CONNECTIONS: "128";
	SAFETY_MARGIN_PERCENT: "80";
	TURNSTILE_SITE_KEY: "configure-in-cloudflare-dashboard" | "1x00000000000000000000AA";
	JOB_COORDINATORS: DurableObjectNamespace<import("./worker/index").JobCoordinatorDO>;
	SWARM_DIRECTORY: DurableObjectNamespace<import("./worker/index").SwarmDirectoryDO>;
	RESULT_VERIFIERS: DurableObjectNamespace<import("./worker/index").ResultVerifierDO>;
	TURNSTILE_SECRET?: "1x0000000000000000000000000000000AA";
	NETWORK_DIGEST_KEY?: "development-only-network-digest-key";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "JobCoordinatorDO" | "SwarmDirectoryDO" | "ResultVerifierDO";
	}
	interface ProductionEnv {
		...
		MAX_DIRECTORY_CONNECTIONS: "128";
		SAFETY_MARGIN_PERCENT: "80";
		TURNSTILE_SITE_KEY: "configure-in-cloudflare-dashboard";
		JOB_COORDINATORS: DurableObjectNamespace<import("./worker/index").JobCoordinatorDO>;
		SWARM_DIRECTORY: DurableObjectNamespace<import("./worker/index").SwarmDirectoryDO>;
		RESULT_VERIFIERS: DurableObjectNamespace<import("./worker/index").ResultVerifierDO>;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "FEATURE_PUBLIC_JOBS" | "FEATURE_PUBLIC_SWARM" | "MAX_ACTIVE_JOBS" | "MAX_JOB_CONNECTIONS" | "MAX_DIRECTORY_CONNECTIONS" | "SAFETY_MARGIN_PERCENT" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET" | "NETWORK_DIGEST_KEY">> {}
}
